...
export type MessionsInfoQueryVariables = Exact<{ [key: string]: never; }>;


export type MessionsInfoQuery = (
  { __typename?: 'Query' }
...
export type LounchMessionInfoQueryVariables = Exact<{
  id: Scalars['String'];
}>;


export type LounchMessionInfoQuery = (
  { __typename?: 'Query' }
  & { launch?: Maybe<(
    { __typename?: 'Launch' }
...
export const MessionsInfoDocument = gql`
    query MessionsInfo {
  launches {
    mission_id
    mission_name
...
/**
 * __useMessionsInfoQuery__
 *
 * To run a query within a React component, call `useMessionsInfoQuery` and pass it any options that fit your needs.
 * When your component renders, `useMessionsInfoQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useMessionsInfoQuery({
 *   variables: {
 *   },
 * });
 */
export function useMessionsInfoQuery(baseOptions?: Apollo.QueryHookOptions<MessionsInfoQuery, MessionsInfoQueryVariables>) {
        return Apollo.useQuery<MessionsInfoQuery, MessionsInfoQueryVariables>(MessionsInfoDocument, baseOptions);
      }
export function useMessionsInfoLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<MessionsInfoQuery, MessionsInfoQueryVariables>) {
          return Apollo.useLazyQuery<MessionsInfoQuery, MessionsInfoQueryVariables>(MessionsInfoDocument, baseOptions);
        }
export type MessionsInfoQueryHookResult = ReturnType<typeof useMessionsInfoQuery>;
export type MessionsInfoLazyQueryHookResult = ReturnType<typeof useMessionsInfoLazyQuery>;
export type MessionsInfoQueryResult = Apollo.QueryResult<MessionsInfoQuery, MessionsInfoQueryVariables>;
export const LounchMessionInfoDocument = gql`
    query lounchMessionInfo($id: String!) {
  launch(id: $id) {
    mission_name
    launch_year
    launch_success
...
/**
 * __useLounchMessionInfoQuery__
 *
 * To run a query within a React component, call `useLounchMessionInfoQuery` and pass it any options that fit your needs.
 * When your component renders, `useLounchMessionInfoQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 ...
 * });
 */
export function useLounchMessionInfoQuery(baseOptions: Apollo.QueryHookOptions<LounchMessionInfoQuery, LounchMessionInfoQueryVariables>) {
        return Apollo.useQuery<LounchMessionInfoQuery, LounchMessionInfoQueryVariables>(LounchMessionInfoDocument, baseOptions);
      }
export function useLounchMessionInfoLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<LounchMessionInfoQuery, LounchMessionInfoQueryVariables>) {
          return Apollo.useLazyQuery<LounchMessionInfoQuery, LounchMessionInfoQueryVariables>(LounchMessionInfoDocument, baseOptions);
        }
export type LounchMessionInfoQueryHookResult = ReturnType<typeof useLounchMessionInfoQuery>;
export type LounchMessionInfoLazyQueryHookResult = ReturnType<typeof useLounchMessionInfoLazyQuery>;
export type LounchMessionInfoQueryResult = Apollo.QueryResult<LounchMessionInfoQuery, LounchMessionInfoQueryVariables>;